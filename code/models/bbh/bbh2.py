...
class BBH2Model(CouplingMPOModel):
    ...
    def init_terms(self, params):
        ...
        # gamma (top right)
        t1_coupling = np.array([[t1, 0, t1, 0, t1, 0],
                               [0, 0, 0, 0, 0, 0],
                               [t1, 0, t1, 0, t1, 0],
                               [0, 0, 0, 0, 0, 0],
                               [t1, 0, t1, 0, t1, 0],
                               [0, 0, 0, 0, 0, 0]])
        # gamma (top left)
        t2_coupling = np.array([[t2, 0, t2, 0, t2, 0],
                                [0, 0, 0, 0, 0, 0],
                                [t2, 0, t2, 0, t2, 0],
                                [0, 0, 0, 0, 0, 0],
                                [t2, 0, t2, 0, t2, 0],
        ...
        t3_coupling = np.array([[0, 0, 0, 0, 0, 0],
                                ...
                                [0, t3, 0, t3, 0, t3]])
        # lambda (top left)
        t4_coupling = np.array([[0, 0, 0, 0, 0, 0],
                                [0, t4, 0, t4, 0, t4],
                                [0, 0, 0, 0, 0, 0],
                                [0, t4, 0, t4, 0, t4],
                                [0, 0, 0, 0, 0, 0],
        ...
        self.add_coupling(t1_coupling, 0, creation, 0, annihilation, np.array([1, 1]), plus_hc=True, category='t1')
        self.add_coupling(t2_coupling, 0, creation, 0, annihilation, np.array([-1, 1]), plus_hc=True, category='t2')
        self.add_coupling(t3_coupling, 0, creation, 0, annihilation, np.array([1, 1]), plus_hc=True, category='t3')
        self.add_coupling(t4_coupling, 0, creation, 0, annihilation, np.array([-1, 1]), plus_hc=True, category='t4')


if __name__ == "__main__":

    model_params = dict(statistics='fermions', conserve='N', t1=1, t2=1, t3=0, t4=0, n=(int(1), int(2)),
