...
def my_Ly_flow_spin(model, lattice, initial_state, tile_unit, chi_max, chi_max_K, J, Js, Jv, Lx, Ly_min, Ly_max, Ly_samp):

    ent_scal_stem = f.file_name_stem("ent_scal", model, lattice, initial_state, tile_unit, chi_max)
    ent_scal_leaf = ("J_%s_Js_%s_Jv_%s_Lx_%s_Ly_%s_%s.dat" % (J, Js, Jv, Lx, Ly_min, Ly_max))
    ...
    for Ly in np.linspace(Ly_min, Ly_max, Ly_samp, dtype=int):
        ...
        (E, psi, M) = f.run_iDMRG_spin_pickle("Ly_flow", model, lattice, initial_state, tile_unit, chi_max,
                                              J, Js, Jv, Lx, Ly, p.use_pickle, p.make_pickle)
        ...
        ent_spec_real_leaf = ("J_%s_Js_%s_Jv_%s_Lx_%s_Ly_%s.dat" % (J, Js, Jv, Lx, Ly))
        ...
        ent_spec_mom_leaf = ("chi_K_%s_J_%s_Js_%s_Jv_%s_Lx_%s_Ly_%s.dat" % (chi_max_K, J, Js, Jv, Lx, Ly))
...
if __name__ == '__main__':
    ...
    my_Ly_flow_spin(p.model, p.lattice, p.initial_state, p.tile_unit, p.chi_max, p.chi_max_K, p.J, p.Js, p.Jv, p.Lx,
