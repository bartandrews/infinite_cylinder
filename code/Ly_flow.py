...
def my_Ly_flow(model, lattice, initial_state, tile_unit, chi_max, t, U, mu, V, Lx, Ly_min, Ly_max, Ly_samp):
    ...
    ent_scal_file = ent_scal_stem + ent_scal_leaf
    ...
    for Ly in np.linspace(Ly_min, Ly_max, Ly_samp, dtype=int):
        ...
        ent_spec_leaf = ("t_%s_U_%s_mu_%s_V_%s_Lx_%s_Ly_%s.dat" % (t, U, mu, V, Lx, Ly))
        ent_spec_real_file = ent_spec_real_stem + ent_spec_leaf
        ...
        ent_spec_mom_file = ent_spec_mom_stem + ent_spec_leaf
