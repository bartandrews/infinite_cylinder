...
if __name__ == '__main__':
    ...
    fig.text(0.64, 0.91, "$\epsilon_\\alpha\equiv-\ln\Lambda_\\alpha^2$", color="w", fontsize=14)

    plt.savefig("/home/bart/Documents/presentations/2021_03_18/figures/phi_flow_nu_1_3_second_new.png", bbox_inches='tight', dpi=300)
    plt.show()