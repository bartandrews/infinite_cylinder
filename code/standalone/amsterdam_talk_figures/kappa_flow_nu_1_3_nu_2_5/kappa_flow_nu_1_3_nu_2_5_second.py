...
########################################################################################################################
    ...
    fig.text(0.145, 0.395, '$\\nu=2/5$', fontsize=11, verticalalignment='top',
    ...
    plt.savefig("/home/bart/Documents/presentations/2021_03_18/figures/kappa_flow_nu_1_3_nu_2_5_second_new.png", bbox_inches='tight', dpi=300)
    plt.show()
