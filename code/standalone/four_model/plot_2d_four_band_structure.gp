...
plot '2D_four_band_structure.txt' u 1:2:6 w p lc palette,\
     '2D_four_band_structure.txt' u 1:3:7 w p lc palette,\
     '2D_four_band_structure.txt' u 1:4:8 w p lc palette,\
     '2D_four_band_structure.txt' u 1:5:9 w p lc palette
