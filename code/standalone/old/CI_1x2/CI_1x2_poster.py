...
if __name__ == '__main__':
    ...
    fig.text(0.2, 0.7, '$C=2$', fontsize=10)
    ...
    left, bottom, width, height = [0.29, 0.1, 0.2, 0.4]  # left = 0.12
    ...
    plt.savefig("/home/bart/Documents/papers/TBG/figures/CI_1x2_poster.png", bbox_inches='tight', dpi=300)
    plt.show()