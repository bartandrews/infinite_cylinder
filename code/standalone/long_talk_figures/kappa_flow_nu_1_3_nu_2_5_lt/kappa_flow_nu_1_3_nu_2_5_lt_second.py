...
########################################################################################################################
    ...
    with open('DeltaQL.dat', 'r') as csvfile:
        ...
        for row in plots:
            ...
            FQH_charge.append(float(row[1]))
            FQH_charge_1_5.append(float(row[2]))


    # ax0.plot(phi_FQH, FQH_charge[chi], 's', marker='o', color='k',
    #          markersize=3, mec='k')

    ax1.plot(phi_FQH, FQH_charge, marker='o', linestyle='-', color='b', markersize=5, zorder=5, label='$\\nu=1/3$')
    ax1.plot(phi_FQH, FQH_charge_1_5, marker='s', linestyle='-', color='r', markersize=5, zorder=5, label='$\\nu=2/5$')
    ...
    ax2.plot(phi_FQH, FQH_charge, marker='o', linestyle='-', color='b', markersize=5, zorder=5, label='$\\nu=1/3$')
    ax2.plot(phi_FQH, FQH_charge_1_5, marker='s', linestyle='-', color='r', markersize=5, zorder=5, label='$\\nu=2/5$')
    ...
    fig.text(0.225, 0.9, 'FQH state', fontsize=11, color='w')
    # fig.text(0.6, 0.9, 'top. trivial', fontsize=11)
    ...
    ax2.set_ylim([2, 3])
    ax2.set_yticks(np.arange(2, 3, 0.2))
...
########################################################################################################################
    ...
    fig.text(0.145, 0.395, '$\\nu=2/5$', fontsize=11, verticalalignment='top', bbox=dict(boxstyle='round', facecolor='white', alpha=1))

    plt.savefig("/home/bart/Documents/presentations/2020_02_21/figures/kappa_flow_nu_1_3_nu_2_5_lt_second.png", bbox_inches='tight', dpi=300)
    plt.show()
