...
if __name__ == '__main__':
    ...
    # 1st up
    ax.scatter(-7*avec[0, 0]+delta[1, 0]+2*0*avec[0, 0]+0*avec[0, 0], -3*avec[0, 1]+delta[1, 1]+0*avec[0, 1] +0.22, color='k', zorder=4, facecolors='k')
    # 1st right
...
########################################################################################################################
    ...
    plt.savefig("/home/bart/Documents/presentations/2020_02_21/figures/lattice_nu_2_5_nphi_1_3_Ly_5_full1_lt.png", bbox_inches='tight', dpi=300)
    plt.show()