...
########################################################################################################################
    ...
    # ax.set_position(pos=[0.1, 0.1, 0.9, 0.9])

    plt.savefig("/home/bart/Documents/presentations/2020_02_21/figures/lattice_nu_2_5_nphi_1_3_Ly_5_lt.png", bbox_inches='tight', dpi=300)
    plt.show()