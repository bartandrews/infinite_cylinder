...
if __name__ == '__main__':
    ...
    fig.text(0.11, 0.6, "o", color="k", fontsize=25)

    plt.savefig("/home/bart/Documents/presentations/2020_02_21/figures/Ly_flow_nu_1_3_lt_second.png", bbox_inches='tight', dpi=300)
    plt.show()