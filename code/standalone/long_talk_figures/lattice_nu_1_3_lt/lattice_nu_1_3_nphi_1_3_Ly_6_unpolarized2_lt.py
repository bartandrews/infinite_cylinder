...
if __name__ == '__main__':
    ...
    # 2nd up
    ax.scatter(-7 * avec[0, 0] + delta[1, 0] + 2 * 1 * avec[0, 0] + 3 * avec[0, 0], -3 * avec[0, 1] + delta[1, 1] + 3 * avec[0, 1] + 0.21, color='k', zorder=4, facecolors='k')
    # 2nd right
    ax.scatter(-7 * avec[0, 0] + delta[1, 0] + 2 * 1 * avec[0, 0] + 3 * avec[0, 0] + 0.21, -3 * avec[0, 1] + delta[1, 1] + 3 * avec[0, 1] + 0.01, color='k', zorder=4, facecolors='w')
...
########################################################################################################################
    ...
    plt.savefig("/home/bart/Documents/presentations/2020_02_21/figures/lattice_nu_1_3_nphi_1_3_Ly_6_unpolarized2_lt.png", bbox_inches='tight', dpi=300)
    plt.show()