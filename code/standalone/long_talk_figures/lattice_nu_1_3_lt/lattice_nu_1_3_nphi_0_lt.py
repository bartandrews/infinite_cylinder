...
if __name__ == '__main__':
    ...
    muc = Polygon(((-7*avec[0, 0], -3*avec[0, 1]), (-7*avec[0, 0]+avec[0, 0], -3*avec[0, 1]+avec[0, 1]), (-7*avec[0, 0]+3*avec[0, 0], -3*avec[0, 1]+avec[0, 1]), (-7*avec[0, 0]+2*avec[0, 0], -3*avec[0, 1]+0)), fc=(1, 1, 0, 0.2))

    #uc = Polygon(((0, 0), (avec[0, 0], avec[0, 1]), (3 * avec[0, 0], avec[0, 1]), (2 * avec[0, 0], 0)), fill=False, ec='g')

    fig.text(0.2, 0.9, "$n_\phi=0$", fontsize=14)
...
########################################################################################################################
    ...
    plt.savefig("/home/bart/Documents/presentations/2020_02_21/figures/lattice_nu_1_3_nphi_0_lt.png", bbox_inches='tight', dpi=300)
    plt.show()