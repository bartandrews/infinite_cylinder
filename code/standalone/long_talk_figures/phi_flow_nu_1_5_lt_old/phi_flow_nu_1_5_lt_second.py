...
if __name__ == '__main__':
    ...
    fig.text(0.64, 0.92, "$\epsilon_\\alpha\equiv-\log\Lambda_\\alpha^2$", color="w", fontsize=14)

    plt.savefig("/home/bart/Documents/papers/long_talk/figures/phi_flow_nu_1_5_lt_second.png", bbox_inches='tight', dpi=300)
    plt.show()