...
if __name__ == '__main__':
    ...
    for p in range(q):
        ...
        eigenvalues2 = matrix_eigenvalues(p, M, 1, -0.025, 0.1)
    ...
    for eigenvalues, alphas in values1:
        ax1.plot(alphas, eigenvalues, '.', color='blue', markersize=2)
    ...
    for eigenvalues, alphas in values2:
        ax2.plot(alphas, eigenvalues, '.', color='green', markersize=2)
    ...
    fig.text(0.14, 0.86, '$(t_1, t_2, t_2\', \kappa)=(1,0,0,0)$', fontsize=11, verticalalignment='top', bbox=dict(boxstyle='round', facecolor='white', alpha=1))
    fig.text(0.14, 0.602, '$(t_1, t_2, t_2\', \kappa)=(0,1,0,1)$', fontsize=11, verticalalignment='top', bbox=dict(boxstyle='round', facecolor='white', alpha=1))
    fig.text(0.14, 0.346, '$(t_1, t_2, t_2\', \kappa)=(1,-0.025,0.1,1)$', fontsize=11, verticalalignment='top', bbox=dict(boxstyle='round', facecolor='white', alpha=1))

    fig.text(0.16, 0.01, '$q=11$', fontsize=11)

    fig.text(0.425, 0.925, '$(k_x,k_y)=(0,0)$', fontsize=11)

    plt.savefig("/home/bart/Documents/presentations/2020_02_21/figures/butterfly_triple_q_11_lt.png", bbox_inches='tight', dpi=300)
    plt.show()
