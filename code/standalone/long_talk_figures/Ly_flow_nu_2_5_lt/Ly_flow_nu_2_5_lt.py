...
if __name__ == '__main__':
    ...
    ax1.plot(Ly[0], SvN[0], '.', marker='X', c='C9', label='$n_\phi=1/3$', markersize=5, zorder=2, fillstyle='none')
    ax1.plot(Ly[1], SvN[1], '.', marker='p', c='C9', label='$n_\phi=1/4$', markersize=5, zorder=2, fillstyle='none')
    ax1.plot(Ly[2], SvN[2], '.', marker='*', c='C9', label='$n_\phi=1/5$', markersize=5, zorder=2, fillstyle='none')
    ...
    fig.text(0.035, 0.85, "$l_\mathrm{B}\sim n_\phi^{-1/2}$", color="k", fontsize=14)

    fig.text(0.11, 0.58, "o", color="k", fontsize=25)

    plt.savefig("/home/bart/Documents/presentations/2020_02_21/figures/Ly_flow_nu_2_5_lt.png", bbox_inches='tight', dpi=300)
    plt.show()