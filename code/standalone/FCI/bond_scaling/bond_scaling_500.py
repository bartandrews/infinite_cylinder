...
if __name__ == '__main__':
    ...
    for filling in range(8):
        ...
        for chi_num, chi in enumerate([50, 100, 150, 200, 250, 300, 350, 400, 450, 500]):
            ...
            if filling == 0:
                leg = ax1.legend(loc='upper center', handletextpad=0.3, handlelength=1, labelspacing=0.1, borderpad=0.3,
                                 framealpha=1,
                                 edgecolor='k', markerscale=2, fontsize=10, ncol=10, columnspacing=0.5,
            ...
            if chi == 50:
                if nphi[0] == 1 and nphi[1] == 5 and Ly_val == 7:
    ...
    plt.savefig("/home/bart/Documents/papers/FCI/bond_scaling_500.png", bbox_inches='tight', dpi=300)
    plt.show()
