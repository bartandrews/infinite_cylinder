...
if __name__ == '__main__':
    ...
    if corr_len_scale:
        ax1.axvline(9.307335857576474, c=f'C9', ls='--', zorder=-3)
    ...
    if corr_len_scale:
        ax2.axvline(23.947622591804954, c='C9', ls='--', zorder=-3)
    ...
    plt.savefig("/home/bart/Documents/papers/FCI/corrfuncext_chi.png", bbox_inches='tight', dpi=300)
    plt.show()
