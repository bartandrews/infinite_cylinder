...
if __name__ == '__main__':
    ...
    ax.plot(phi, charge, '.', c=f'C1', marker=markers[1], fillstyle='none', markersize=5, markeredgewidth=0.2)

    phiflow_file = f'charge_pump_FerHofSqu1_chi_50_t1_1_V_10_Coulomb_1_n_1_140_nphi_7_20_LxMUC_1_Ly_14_phi_0_7_71.dat.modified'
    phiflow_path = os.path.join(phiflow_dir, phiflow_file)
    with open(phiflow_path, 'r') as csvfile:
        plots = csv.reader(csvfile, delimiter='\t')
        phi = []
    ...
    with open(phiflow_path, 'r') as csvfile:
        ...
        for row in plots:
            ...
            charge.append(float(row[1]))
    charge = [i - charge[0] for i in charge]
    ax.plot(phi, charge, '.', c=f'C2', marker=markers[1], fillstyle='none', markersize=5, markeredgewidth=0.2)
    ...
    with open(phiflow_path, 'r') as csvfile:
        ...
        for row in plots:
            ...
            charge.append(float(row[1]))
    charge = [i - charge[0] for i in charge]
    ax1.plot(phi, charge, '.', c=f'C1', marker=markers[8], fillstyle='none', markersize=5, markeredgewidth=0.2)
