...
if __name__ == '__main__':
    ...
    fig.text(0.035, 0.39, "(c)", fontsize=12)
    fig.text(0.48, 0.39, "(d)", fontsize=12)

    plt.savefig("/home/bart/Documents/papers/FCI/phiflow_c45_analysis.png", bbox_inches='tight', dpi=300)
    plt.show()
