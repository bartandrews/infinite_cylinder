...
if __name__ == '__main__':
    ...
    #
    # # specify the input file
    # file = f'/home/bart/PycharmProjects/infinite_cylinder/logs/observables/{model}/out/{model}_Vrange_1_{filling}_total.out'
    #
    # # plot with error bars?
    # error_bars = True
    #
    ...
    #
    # # specify the input file
    # file = f'/home/bart/PycharmProjects/infinite_cylinder/logs/observables/{model}/out/{model}_Vrange_2_{filling}_total.out'
    #
    # # plot with error bars?
    # error_bars = True
    #
