...
if __name__ == '__main__':
    ...
    ax3.text(0.45, 1.4, "$\displaystyle{\sigma_\\text{H}=\\frac{2}{5}\\frac{e^2}{h}}$",
             bbox=dict(facecolor='white', alpha=1, lw=0.5, ls='-'))

    ax3.tick_params(axis="x", labelsize=10)
    ax3.set_xlim([0, 5])
    ax3.set_xticks(np.arange(0, 5.1, 1))
    ...
    # left, bottom, width, height = [0.215, 0.535, 0.25, 0.25]
    left, bottom, width, height = [0.225, 0.065, 0.25, 0.25]  # left = 0.12
    ...
    plt.savefig("/home/bart/Documents/papers/TEE/case_study_2_5_kappa_2_3.png", bbox_inches='tight', dpi=300)
    plt.show()
