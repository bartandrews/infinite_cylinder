...
if __name__ == '__main__':
    ...
    ax.annotate("", xy=(3*avec[0, 0], -3*avec[0, 1]), xycoords='data', xytext=(9*avec[0, 0], 3*avec[0, 1]), textcoords='data',
               arrowprops=dict(arrowstyle="<->", connectionstyle="arc3", color='k', lw=2))
    ax.text(6.3 * avec[0, 0], -0.3 * avec[0, 1], '$L_y=6$', fontsize=11)

    ax.annotate("", xy=(-1 * avec[0, 0], 3 * avec[0, 1]), xycoords='data', xytext=(9 * avec[0, 0], 3 * avec[0, 1]),
                textcoords='data',
                arrowprops=dict(arrowstyle="<->", connectionstyle="arc3", color='k', lw=2))
    ax.text(3.25 * avec[0, 0], 3.2 * avec[0, 1], '$L_x=1$', fontsize=11)
    ...
    ax.set_xlim([-7*avec[0, 0], 9*avec[0, 0]])
    ax.set_xticks(np.arange(-7 * avec[0, 0], 9 * avec[0, 0]+0.1, step=2*avec[0, 0]))
    ...
    muc = Polygon(((-7*avec[0, 0], -3*avec[0, 1]), (-1*avec[0, 0], 3*avec[0, 1]), (9*avec[0, 0], 3*avec[0, 1]), (-7*avec[0, 0]+5*2*avec[0, 0], -3*avec[0, 1]+0)), fc=(1, 1, 0, 0.2))
    ...
    fig.text(0.2, 0.85, "$n_\phi=1/5$", fontsize=11)
...
########################################################################################################################
    ...
    plt.savefig("/home/bart/Documents/presentations/2019_12_13/figures/lattice_nu_1_3_nphi_1_5.png", bbox_inches='tight', dpi=300)
    plt.show()