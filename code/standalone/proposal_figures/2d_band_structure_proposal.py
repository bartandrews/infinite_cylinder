...
if __name__ == '__main__':
    ...
    cset = ax4.contour(E1[i], np.arange(2, 5, 0.25), linewidths=0.25, colors='black')
...
########################################################################################################################
    ...
    fig.text(0.5, 0.425, "$n_\phi=10/11$", fontsize=11, backgroundcolor='white')
    ...
    plt.savefig("/home/bart/Documents/FSK2020/proposal/figures/2d_band_structure_proposal.png", bbox_inches='tight', dpi=300)
    plt.show()