...
if __name__ == '__main__':
    ...
    r[2].append({"chi": 250, "n": (2, 21), "nphi": (1, 7), "LxMUC": 1, "Ly": 6, "V_min": 0, "V_max": 0.2, "V_samp": 41})
    r[2].append({"chi": 250, "n": (1, 12), "nphi": (1, 8), "LxMUC": 1, "Ly": 6, "V_min": 0, "V_max": 0.1, "V_samp": 41})

    # populate r=-1 list ()

    # populate r=1 list (nu=1/3, 2 particles)
    # r[4].append({"chi": 250, "n": (1, 9), "nphi": (1, 3), "LxMUC": 1, "Ly": 6, "V_min": 0, "V_max": 1, "V_samp": 41})
    r[4].append({"chi": 250, "n": (1, 12), "nphi": (1, 4), "LxMUC": 1, "Ly": 6, "V_min": 0, "V_max": 0.4, "V_samp": 41})
    # r[4].append({"chi": 250, "n": (1, 15), "nphi": (1, 5), "LxMUC": 1, "Ly": 6, "V_min": 0, "V_max": 1, "V_samp": 41})
    r[4].append({"chi": 250, "n": (1, 18), "nphi": (1, 6), "LxMUC": 1, "Ly": 6, "V_min": 0, "V_max": 0.2, "V_samp": 41})
    r[4].append({"chi": 250, "n": (1, 21), "nphi": (1, 7), "LxMUC": 1, "Ly": 6, "V_min": 0, "V_max": 0.2, "V_samp": 41})
    r[4].append({"chi": 250, "n": (1, 24), "nphi": (1, 8), "LxMUC": 1, "Ly": 6, "V_min": 0, "V_max": 0.2, "V_samp": 41})
    ...
    r[5].append({"chi": 250, "n": (2, 25), "nphi": (1, 5), "LxMUC": 1, "Ly": 10, "V_min": 0, "V_max": 0.1, "V_samp": 41})
    # r[5].append({"chi": 250, "n": (1, 15), "nphi": (1, 6), "LxMUC": 1, "Ly": 10, "V_min": 0, "V_max": 1, "V_samp": 41})
    r[5].append({"chi": 250, "n": (2, 35), "nphi": (1, 7), "LxMUC": 1, "Ly": 10, "V_min": 0, "V_max": 0.1, "V_samp": 41})
    r[5].append({"chi": 250, "n": (1, 20), "nphi": (1, 8), "LxMUC": 1, "Ly": 10, "V_min": 0, "V_max": 0.1, "V_samp": 41})
